...
public class Main {
    public static void main(String[] args){
        ...
        System.out.print(Time.BEFORE + malish.toString() + malish.saw() + Where.INDOOR + Form.HER + leg.BigLeg() + leg + Other.DOT);
        System.out.println(malish.toString() + Other.COMMA + malish.fluttered() + "так " + Form.HE + malish.scared() + Other.COMMA + How.ALTHOUGH + malish.waited() + Form.HER + "и " + malish.knew() + Other.COMMA + "что " + Form.SHE + Time.NOW + bok.WillCome() + Other.DOT);
        System.out.print(bok.toString() + How.GLOOMILY + bok.looked() + "на " + Form.HIM + Other.DOT);
        ...
        System.out.print(bok.toString() + " это " + How.TOO + bok.HeardWom() + Other.DOT);
    }
}