...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println(Form.ITHE + "так " + malish.cheated() + Other.COMMA + "чтобы " + bok.force() + Form.HER + bok.WillCome() + Where.BYWINDOW + Other.COMMA + "а " + Form.MYSELF + How.IMPTRCEPTIBLY + malish.shoved() + Where.UNDERCURTAIN + Other.COMMA + Where.FORWHICH + cord + Other.COMMA + "и " + malish.pulled() + Form.HIS + How.STRONGLY + Other.DOT);
